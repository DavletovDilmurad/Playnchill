                  ...
                  <div>
                    <div className='relative z-10'>
                      ...
                      <div className='flex items-end gap-5'>
                        <p className='font-extrabold text-2xl text-white max-[970px]:text-base'>{item.price} Р</p>
                        <p className='font-extrabold text-lg text-yellow-300 max-[970px]:text-base'>-{item.discount}%</p>
                        <p className='font-extrabold text-lg text-neutral-600 line-through max-[970px]:text-base'>{item.oldprice} Р</p>
                      </div>
                    </div>
